        ...
        imports: [
            ...
            typeorm_1.TypeOrmModule.forRootAsync({
                ...
                useFactory: (config) => ({
                    ...
                    entities: [budget_entity_1.Budget, contractor_entity_1.Contractor],
                    synchronize: true,
                }),
            }),
            typeorm_1.TypeOrmModule.forFeature([budget_entity_1.Budget, contractor_entity_1.Contractor]),
