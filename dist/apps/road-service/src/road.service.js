...
let RoadService = class RoadService {
    ...
    async updateRoad(id, updateDto) {
        ...
        if (updateDto.name !== undefined)
            road.name = updateDto.name;
        if (updateDto.category !== undefined)
            road.category = updateDto.category;
        if (updateDto.authorityName !== undefined)
            road.authorityName = updateDto.authorityName;
        if (updateDto.authorityEmail !== undefined)
            road.authorityEmail = updateDto.authorityEmail;
